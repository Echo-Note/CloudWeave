		...
		pages: {
			company: {
				...
				form: {
					...
					companyTypePlaceholder: '请输入公司类型，如"有限责任公司(法人独资)"',
			...
			messages: {
				...
				uploadLicenseFirst: '请先上传营业执照图片',
				ocrRecognizeSuccess: 'OCR 识别完成，已自动填充',
				ocrRecognizeFailed: 'OCR 识别失败，请重试',
				ocrRecognizing: '识别中...',
			},
			buttons: {
				add: '新增',
