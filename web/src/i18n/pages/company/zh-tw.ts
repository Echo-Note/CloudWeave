		...
		pages: {
			company: {
				...
				form: {
					...
					companyTypePlaceholder: '請輸入公司類型，如"有限責任公司(法人獨資)"',
			...
			messages: {
				...
				uploadLicenseFirst: '請先上傳營業執照圖片',
				ocrRecognizeSuccess: 'OCR 識別完成，已自動填充',
				ocrRecognizeFailed: 'OCR 識別失敗，請重試',
				ocrRecognizing: '識別中...',
			},
			buttons: {
				add: '新增',
