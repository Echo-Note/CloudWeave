...
│                              综合运维管理系统                                   │
├────────┬────────┬────────┬────────┬────────┬──────────┬──────────┬──────────┤
│ 资产   │ 关联   │ ICP    │ 云平台 │ 云API  │ AI智能   │ 可视化   │ 系统     │
│ 管理   │ 关系   │ 备案   │ 管理   │ 集成   │ 集成     │ 拓扑     │ 管理     │
│ 模块   │ 管理   │ 管理   │        │        │ (MCP)    │          │          │
├────────┼────────┼────────┼────────┼────────┼──────────┼──────────┼──────────┤
│· 项目  │· 配置  │· 备案  │· 云平台│· API   │· MCP    │· 拓扑图  │· 用户    │
│· 服务器│· 查询  │  登记  │  账号  │  凭证  │  Server │· 节点    │· 角色    │
│· 域名  │· 影响  │· 备案  │· 注册商│  配置  │· API Key│  探索    │· 权限    │
│· IP    │  分析  │  变更  │· 域名  │· 资产  │  管理   │· 导出    │· 日志    │
│· 端口  │        │· 变更  │  注册  │  同步  │· Tool   │          │          │
│        │        │  历史  │  账户  │· 余额  │  定义   │          │          │
│        │        │· 到期  │        │  同步  │· 调用   │          │          │
│        │        │  提醒  │        │· 告警  │  审计   │          │          │
...
┌──────────────────────────────────────────────────────┐
│  顶部导航栏                                           │
│  [Logo]  仪表盘  │  资产管理  │  云平台  │  告警  │  AI  │  拓扑视图  │  系统管理  │ [用户头像] │
└──────────────────────────────────────────────────────┘
┌──────────────┬────────────────────────────────────────┐
│              │                                        │
│  左侧二级菜单 │              主内容区                   │
...
**备注**：Phase 7 可与 Phase 5-6 并行开发——MCP Server 作为独立进程只需 DRF Service 层稳定即可接入，无需等待前端告警等功能完成。
